  ...
  return (
    ...
    <div
      ...
      className={cn(
        ...
        "fixed right-4 bottom-4 left-4 z-40 w-auto rounded-panel border border-border bg-card p-4 text-card-foreground shadow-[var(--shadow-panel),0_0_0_1px_var(--glass-border-outer)] backdrop-blur-(--glass-blur) backdrop-saturate-[1.4]",
